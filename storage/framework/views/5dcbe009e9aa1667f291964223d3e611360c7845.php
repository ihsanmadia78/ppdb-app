            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php if($pendaftar): ?>
                        ...
                        <div class="alert alert-info mb-4">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <p class="mb-0">
                                        <strong><?php echo e($pendaftar->no_pendaftaran); ?></strong> - 
                                        <span class="badge badge-<?php echo e($pendaftar->status == 'LULUS' ? 'success' : ($pendaftar->status == 'TIDAK_LULUS' ? 'danger' : 'warning')); ?>">
                                ...
                                <div class="col-md-4 text-end">
                                    <small class="text-muted">Terakhir update: <?php echo e($pendaftar->updated_at->format('d M Y, H:i')); ?></small>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="timeline-item <?php echo e(in_array($pendaftar->status, ['SUBMIT', 'MENUNGGU_PEMBAYARAN', 'VERIFIKASI_PEMBAYARAN', 'SIAP_SELEKSI', 'LULUS', 'TIDAK_LULUS', 'CADANGAN']) ? 'completed' : 'pending'); ?>">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <p class="timeline-description">
                                        ...
                                        Anda telah terdaftar untuk jurusan <strong><?php echo e($pendaftar->jurusan->nama ?? '-'); ?></strong> 
                                        pada <strong><?php echo e($pendaftar->gelombang->nama ?? '-'); ?></strong>.
                                    </p>
                                    <div class="timeline-details">
                                        <small class="text-muted">
                                            <i class="fas fa-calendar me-1"></i><?php echo e($pendaftar->created_at->format('d M Y, H:i')); ?>
                            ...
                            <div class="timeline-item <?php echo e($paymentStatus); ?>">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <?php if($pendaftar->pembayaran): ?>
                                        ...
                                        ?>
                                        <p class="timeline-description">
                                            Bukti pembayaran sebesar <strong>Rp <?php echo e(number_format($pendaftar->pembayaran->nominal, 0, ',', '.')); ?></strong> 
                                            telah diupload melalui <?php echo e(strtoupper($pendaftar->pembayaran->metode_pembayaran)); ?>.
                                        </p>
                                        <div class="mb-2">
                                            <span class="badge bg-<?php echo e($config['color']); ?> px-3 py-2">
                                                <i class="fas fa-<?php echo e($pendaftar->pembayaran->status == 'verified' ? 'check-circle' : ($pendaftar->pembayaran->status == 'rejected' ? 'times-circle' : 'clock')); ?> me-1"></i>
                                                <?php echo e($config['text']); ?>

                                            </span>
                                        </div>
                                        <?php if($pendaftar->pembayaran->catatan_verifikasi): ?>
                                            <div class="alert alert-<?php echo e($pendaftar->pembayaran->status == 'rejected' ? 'danger' : 'info'); ?> alert-sm mt-2 mb-2">
                                                <small>
                                                    <strong>Catatan Tim Keuangan:</strong><br>
                                                    <?php echo e($pendaftar->pembayaran->catatan_verifikasi); ?>
                                        ...
                                        <div class="timeline-details">
                                            <small class="text-muted">
                                                <i class="fas fa-calendar me-1"></i>Upload: <?php echo e($pendaftar->pembayaran->created_at->format('d M Y, H:i')); ?>

                                                <?php if($pendaftar->pembayaran->verified_at): ?>
                                                    | Verifikasi: <?php echo e($pendaftar->pembayaran->verified_at->format('d M Y, H:i')); ?>
                                        ...
                                        <?php if($pendaftar->pembayaran->status == 'rejected'): ?>
                                            <div class="timeline-details mt-2">
                                                <a href="<?php echo e(route('siswa.pembayaran')); ?>" class="btn btn-sm btn-warning">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="timeline-details">
                                            <a href="<?php echo e(route('siswa.pembayaran')); ?>" class="btn btn-sm btn-primary">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <?php if($pendaftar->status == 'LULUS'): ?>
                                        <div class="alert alert-success mb-0">
                                            ...
                                            <p class="mb-2">
                                                Anda telah diterima di <strong><?php echo e($pendaftar->jurusan->nama); ?></strong>. 
                                                Silakan cetak kartu peserta dan ikuti instruksi selanjutnya.
                                            </p>
                                            <small class="text-muted">
                                                <i class="fas fa-calendar me-1"></i><?php echo e($pendaftar->updated_at->format('d M Y, H:i')); ?>
                        ...
                        <!-- Action Buttons -->
                        <?php if(in_array($pendaftar->status, ['LULUS', 'CADANGAN'])): ?>
                        <div class="row mt-4">
...
<?php echo $__env->make('siswa.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\ppdb-app\resources\views/siswa/timeline.blade.php ENDPATH**/ ?>
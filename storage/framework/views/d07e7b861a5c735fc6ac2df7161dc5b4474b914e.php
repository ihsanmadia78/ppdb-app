<?php $__env->startSection('title', 'Konfirmasi Pendaftaran PPDB'); ?>
...
<div style="background: #f8f9fa; border-radius: 10px; padding: 20px; margin: 20px 0; border-left: 5px solid #28a745;">
    ...
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
            ...
            <td style="padding: 10px 0; border-bottom: 1px solid #dee2e6; color: #007bff; font-weight: bold;"><?php echo e($pendaftar->no_pendaftaran); ?></td>
        </tr>
        <tr>
            <td style="padding: 10px 0; border-bottom: 1px solid #dee2e6;"><strong>👤 Nama Lengkap:</strong></td>
            <td style="padding: 10px 0; border-bottom: 1px solid #dee2e6;"><?php echo e($pendaftar->dataSiswa->nama ?? '-'); ?></td>
        </tr>
        <tr>
            <td style="padding: 10px 0; border-bottom: 1px solid #dee2e6;"><strong>🆔 NISN:</strong></td>
            <td style="padding: 10px 0; border-bottom: 1px solid #dee2e6;"><?php echo e($pendaftar->dataSiswa->nisn ?? '-'); ?></td>
        </tr>
        <tr>
            <td style="padding: 10px 0; border-bottom: 1px solid #dee2e6;"><strong>📧 Email:</strong></td>
            <td style="padding: 10px 0; border-bottom: 1px solid #dee2e6;"><?php echo e($pendaftar->email); ?></td>
        </tr>
        <tr>
            <td style="padding: 10px 0; border-bottom: 1px solid #dee2e6;"><strong>🎓 Jurusan Pilihan:</strong></td>
            <td style="padding: 10px 0; border-bottom: 1px solid #dee2e6;"><?php echo e($pendaftar->jurusan->nama ?? '-'); ?></td>
        </tr>
        <tr>
            <td style="padding: 10px 0; border-bottom: 1px solid #dee2e6;"><strong>🌊 Gelombang:</strong></td>
            <td style="padding: 10px 0; border-bottom: 1px solid #dee2e6;"><?php echo e($pendaftar->gelombang->nama ?? '-'); ?></td>
        </tr>
        <tr>
            <td style="padding: 10px 0; border-bottom: 1px solid #dee2e6;"><strong>📅 Tanggal Daftar:</strong></td>
            <td style="padding: 10px 0; border-bottom: 1px solid #dee2e6;"><?php echo e($pendaftar->created_at->format('d F Y, H:i')); ?> WIB</td>
        </tr>
        <tr>
...
<div style="text-align: center; margin: 30px 0;">
    ...
    <a href="<?php echo e(url('/pendaftaran/cek')); ?>" style="display: inline-block; padding: 15px 30px; background: #007bff; color: white; text-decoration: none; border-radius: 25px; margin: 5px; font-weight: bold;">🔍 Cek Status Pendaftaran</a>
    <a href="<?php echo e(url('/siswa/login')); ?>" style="display: inline-block; padding: 15px 30px; background: #28a745; color: white; text-decoration: none; border-radius: 25px; margin: 5px; font-weight: bold;">🚪 Login Portal Siswa</a>
</div>
...
<?php echo $__env->make('emails.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\ppdb-app\resources\views/emails/pendaftaran-confirmation.blade.php ENDPATH**/ ?>
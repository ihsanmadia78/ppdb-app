                    ...
                    <div class="card-body p-5">
                        ...
                        <form method="POST" action="<?php echo e(route('register.post')); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control" value="<?php echo e(old('name')); ?>" placeholder="Masukkan nama lengkap Anda" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label"><i class="fas fa-envelope me-2"></i>Email</label>
                                <input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="contoh@email.com" required>
                        ...
                        <div class="text-center mt-4">
                            ...
                            <p class="text-muted">Sudah punya akun? <a href="<?php echo e(route('siswa.login')); ?>" class="text-decoration-none fw-bold">pergi ke portal siswa</a></p>
                            <div class="d-flex justify-content-between">
                                <a href="<?php echo e(route('welcome')); ?>" class="text-decoration-none text-muted">
                                    <i class="fas fa-arrow-left me-1"></i>Kembali ke Beranda
                                </a>
                                <a href="<?php echo e(route('registration.flow')); ?>" class="text-decoration-none text-muted">
...
</html><?php /**PATH C:\xampp\ppdb-app\resources\views/auth/register.blade.php ENDPATH**/ ?>
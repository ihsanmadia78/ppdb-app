...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Kelola dan pantau keuangan PPDB SMK BaktiNusantara 666 - <?php echo e(date('d F Y')); ?></p>
        </div>
        <div class="d-flex gap-2">
            <button class="btn btn-secondary btn-sm" onclick="window.print()">
                <i class="fas fa-print"></i> Cetak Laporan
            </button>
            <a href="<?php echo e(route('keuangan.laporan')); ?>" class="btn btn-outline-secondary btn-sm">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(number_format($totalPendaftarSudahBayar ?? 0)); ?></div>
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(number_format($totalPendaftarBelumBayar ?? 0)); ?></div>
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(number_format($menungguVerifikasi ?? 0)); ?></div>
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">Rp <?php echo e(number_format($totalUangMasukKeseluruhan ?? 0, 0, ',', '.')); ?></div>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-xl-3 col-md-6">
                    <a href="<?php echo e(route('keuangan.pembayaran', ['status' => 'paid'])); ?>" class="btn btn-warning w-100 py-3 text-decoration-none">
                        <div class="d-flex flex-column align-items-center">
                            <i class="fas fa-clock fa-2x mb-2"></i>
                            <span class="fw-bold">Verifikasi Pembayaran</span>
                            <small class="text-dark opacity-75"><?php echo e($menungguVerifikasi ?? 0); ?> menunggu</small>
                        </div>
                    </a>
                </div>
                <div class="col-xl-3 col-md-6">
                    <a href="<?php echo e(route('keuangan.pembayaran')); ?>" class="btn btn-secondary w-100 py-3 text-decoration-none">
                        <div class="d-flex flex-column align-items-center">
                ...
                <div class="col-xl-3 col-md-6">
                    <a href="<?php echo e(route('keuangan.laporan')); ?>" class="btn btn-outline-secondary w-100 py-3 text-decoration-none">
                        <div class="d-flex flex-column align-items-center">
                ...
                <div class="col-xl-3 col-md-6">
                    <a href="<?php echo e(route('keuangan.pembayaran.manual')); ?>" class="btn btn-success w-100 py-3 text-decoration-none">
                        <div class="d-flex flex-column align-items-center">
            ...
            <div class="row g-3 mt-2">
                <div class="col-xl-3 col-md-6">
                    <a href="<?php echo e(route('keuangan.histori')); ?>" class="btn btn-info w-100 py-3 text-decoration-none">
                        <div class="d-flex flex-column align-items-center">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('keuangan.pembayaran', ['status' => 'paid'])); ?>" class="btn btn-sm btn-outline-secondary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\ppdb-app\resources\views/keuangan/dashboard.blade.php ENDPATH**/ ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="<?php echo e(route('admin.jurusan.delete', $j->id)); ?>" class="d-inline" onsubmit="return confirm('Yakin hapus jurusan ini?')">
...
function editJurusan(id, nama, kode, kuota) {
    document.getElementById('editForm').action = `<?php echo e(url('/admin/jurusan/update')); ?>/${id}`;
...
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\ppdb-app\resources\views/admin/jurusan.blade.php ENDPATH**/ ?>
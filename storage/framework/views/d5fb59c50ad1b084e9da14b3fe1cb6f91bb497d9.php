            ...
            <div class="navbar-nav ms-auto">
                ...
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if(Auth::user()->role == 'eksekutif'): ?>
                            <li><a class="dropdown-item" href="<?php echo e(route('eksekutif.dashboard')); ?>"><i class="fas fa-chart-line me-2"></i>Dashboard Eksekutif</a></li>
                        <?php elseif(Auth::user()->role == 'verifikator'): ?>
                            <li><a class="dropdown-item" href="<?php echo e(route('verifikator.dashboard')); ?>"><i class="fas fa-tachometer-alt me-2"></i>Dashboard</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('verifikator.pendaftar')); ?>"><i class="fas fa-users me-2"></i>Daftar Pendaftar</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('verifikator.riwayat')); ?>"><i class="fas fa-history me-2"></i>Riwayat Verifikasi</a></li>
                        <?php elseif(Auth::user()->role == 'keuangan'): ?>
                            <li><a class="dropdown-item" href="<?php echo e(route('keuangan.dashboard')); ?>"><i class="fas fa-tachometer-alt me-2"></i>Dashboard</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('keuangan.pembayaran')); ?>"><i class="fas fa-money-bill me-2"></i>Daftar Pembayaran</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('keuangan.laporan')); ?>"><i class="fas fa-chart-bar me-2"></i>Laporan Keuangan</a></li>
                        <?php elseif(Auth::user()->role == 'siswa'): ?>
                            <li><a class="dropdown-item" href="<?php echo e(route('siswa.dashboard')); ?>"><i class="fas fa-tachometer-alt me-2"></i>Dashboard</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('siswa.pembayaran')); ?>"><i class="fas fa-credit-card me-2"></i>Pembayaran</a></li>
                        <?php else: ?>
                            <li><a class="dropdown-item" href="<?php echo e(route('dashboard')); ?>"><i class="fas fa-tachometer-alt me-2"></i>Dashboard</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.pendaftar')); ?>"><i class="fas fa-users me-2"></i>Pendaftar</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><h6 class="dropdown-header">Data Master</h6></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.jurusan')); ?>"><i class="fas fa-graduation-cap me-2"></i>Jurusan</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.gelombang')); ?>"><i class="fas fa-calendar-alt me-2"></i>Gelombang</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.biaya')); ?>"><i class="fas fa-money-bill-wave me-2"></i>Biaya</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.wilayah')); ?>"><i class="fas fa-map-marker-alt me-2"></i>Wilayah</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.users')); ?>"><i class="fas fa-user-cog me-2"></i>Users</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.settings')); ?>"><i class="fas fa-cog me-2"></i>Settings</a></li>
                        <?php endif; ?>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('logout')); ?>"><i class="fas fa-sign-out-alt me-2"></i>Logout</a></li>
                    </ul>
                </div>
            </div>
            <?php endif; ?>
...
<?php /**PATH C:\xampp\ppdb-app\resources\views/layouts/app.blade.php ENDPATH**/ ?>
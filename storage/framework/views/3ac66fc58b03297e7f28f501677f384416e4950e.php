...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="d-flex gap-3">
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-secondary btn-lg px-4">
                            <i class="fas fa-user-plus me-2"></i>Daftar Sekarang
                        </a>
                        <a href="<?php echo e(route('pendaftaran.cek')); ?>" class="btn btn-outline-secondary btn-lg px-4">
                            <i class="fas fa-search me-2"></i>Cek Status
                        </a>
                        <a href="<?php echo e(route('siswa.login')); ?>" class="btn btn-outline-secondary btn-lg px-4">
    ...
    <section class="cta-section">
        <div class="container text-center">
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn btn-light btn-lg px-5 text-secondary me-3">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-md-end">
                    <p class="text-muted mb-0">&copy; <?php echo e(date('Y')); ?> PPDB SMK BaktiNusantara 666. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
...
</html><?php /**PATH C:\xampp\ppdb-app\resources\views/welcome.blade.php ENDPATH**/ ?>
                    ...
                    <div class="success-body">
                        <?php if($pendaftar): ?>
                                        ...
                                        <div class="col-md-6">
                                            <table class="table table-borderless table-sm">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-success">Rp <?php echo e(number_format($pendaftar->gelombang?->biaya_daftar ?? 0, 0, ',', '.')); ?></td>
                                                </tr>
                                            </table>
                                        </div>
                                        <div class="col-md-6">
                                            <table class="table table-borderless table-sm">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge bg-info"><?php echo e($pendaftar->berkas->count()); ?> berkas</span></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                            ...
                            <div class="alert alert-warning mt-4">
                                ...
                                <ul class="mb-0 mt-2">
                                    <li>Simpan nomor pendaftaran: 
                                        <strong class="text-primary"><?php echo e($pendaftar->no_pendaftaran); ?></strong>
                            ...
                            <div class="text-center mt-4">
                                <a href="<?php echo e(route('pendaftaran.cek')); ?>" class="btn btn-dark btn-lg me-2">
                        ...
                        <?php else: ?>
                            <div class="alert alert-warning text-center">
                                ...
                                <a href="<?php echo e(route('pendaftaran.create')); ?>" class="btn btn-dark">
...
<?php /**PATH C:\xampp\ppdb-app\resources\views/pendaftaran/status.blade.php ENDPATH**/ ?>
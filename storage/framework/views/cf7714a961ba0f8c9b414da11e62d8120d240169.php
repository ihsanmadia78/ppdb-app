    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link" href="<?php echo e(route('pendaftaran.cek')); ?>">Cek Status</a>
            </div>
        </div>
    </nav>
            ...
            <div class="col-lg-8">
                <div class="form-container">
                    ...
                    <div class="form-body">
                        ...
                        <form method="POST" action="<?php echo e(route('pendaftaran.store')); ?>" id="registrationForm" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-section active" id="section1">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama" class="form-control" value="<?php echo e(old('nama')); ?>" placeholder="Nama lengkap sesuai ijazah" required>
                                </div>

                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label"><i class="fas fa-id-card me-1"></i>NIK *</label>
                                        <input type="text" name="nik" class="form-control" value="<?php echo e(old('nik')); ?>" placeholder="Nomor Induk Kependudukan (16 digit)" maxlength="16" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="nisn" class="form-control" value="<?php echo e(old('nisn')); ?>" placeholder="Nomor Induk Siswa Nasional" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" name="tmp_lahir" class="form-control" value="<?php echo e(old('tmp_lahir')); ?>" placeholder="Kota kelahiran" required>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label"><i class="fas fa-calendar me-1"></i>Tanggal Lahir *</label>
                                        <input type="date" name="tgl_lahir" class="form-control" value="<?php echo e(old('tgl_lahir')); ?>" required>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="alamat" class="form-control" rows="3" placeholder="Jalan, RT/RW, No. Rumah" required><?php echo e(old('alamat')); ?></textarea>
                                </div>

                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label"><i class="fas fa-map me-1"></i>Provinsi *</label>
                                        <input type="text" name="provinsi" class="form-control" value="<?php echo e(old('provinsi')); ?>" placeholder="Contoh: Jawa Barat" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label"><i class="fas fa-city me-1"></i>Kabupaten/Kota *</label>
                                        <input type="text" name="kabupaten" class="form-control" value="<?php echo e(old('kabupaten')); ?>" placeholder="Contoh: Bandung" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="kecamatan" class="form-control" value="<?php echo e(old('kecamatan')); ?>" placeholder="Nama kecamatan" required>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label"><i class="fas fa-home me-1"></i>Kelurahan/Desa *</label>
                                        <input type="text" name="kelurahan" class="form-control" value="<?php echo e(old('kelurahan')); ?>" placeholder="Nama kelurahan/desa" required>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label"><i class="fas fa-mail-bulk me-1"></i>Kode Pos</label>
                                        <input type="text" name="kode_pos" class="form-control" value="<?php echo e(old('kode_pos')); ?>" placeholder="12345" maxlength="5">
                                    </div>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label"><i class="fas fa-envelope me-1"></i>Email *</label>
                                    <input type="email" name="email" class="form-control" value="<?php echo e($email ?? old('email')); ?>" required placeholder="contoh@email.com" <?php echo e($email ? 'readonly' : ''); ?>>
                                    <?php if($email): ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="npsn_sekolah" class="form-control" value="<?php echo e(old('npsn_sekolah')); ?>" placeholder="8 digit NPSN" maxlength="8">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="nama_sekolah_asal" class="form-control" value="<?php echo e(old('nama_sekolah_asal')); ?>" placeholder="Contoh: SMP Negeri 1 Jakarta" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label"><i class="fas fa-map-marker-alt me-1"></i>Kabupaten Sekolah *</label>
                                        <input type="text" name="kabupaten_sekolah" class="form-control" value="<?php echo e(old('kabupaten_sekolah')); ?>" placeholder="Contoh: Jakarta Pusat" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label"><i class="fas fa-star me-1"></i>Nilai Rata-rata Rapor/Akhir *</label>
                                        <input type="number" name="nilai_rata_rata" class="form-control" value="<?php echo e(old('nilai_rata_rata')); ?>" placeholder="Contoh: 85.50" step="0.01" min="0" max="100" required>
                            ...
                            <div class="form-section" id="section2">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="nama_ayah" class="form-control" value="<?php echo e(old('nama_ayah')); ?>" placeholder="Nama lengkap ayah">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label"><i class="fas fa-briefcase me-1"></i>Pekerjaan Ayah</label>
                                        <input type="text" name="pekerjaan_ayah" class="form-control" value="<?php echo e(old('pekerjaan_ayah')); ?>" placeholder="Contoh: PNS, Wiraswasta">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label"><i class="fas fa-phone me-1"></i>No. HP Ayah</label>
                                        <input type="tel" name="hp_ayah" class="form-control" value="<?php echo e(old('hp_ayah')); ?>" placeholder="08xxxxxxxxxx">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="nama_ibu" class="form-control" value="<?php echo e(old('nama_ibu')); ?>" placeholder="Nama lengkap ibu">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label"><i class="fas fa-briefcase me-1"></i>Pekerjaan Ibu</label>
                                        <input type="text" name="pekerjaan_ibu" class="form-control" value="<?php echo e(old('pekerjaan_ibu')); ?>" placeholder="Contoh: Ibu Rumah Tangga, Guru">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label"><i class="fas fa-phone me-1"></i>No. HP Ibu</label>
                                        <input type="tel" name="hp_ibu" class="form-control" value="<?php echo e(old('hp_ibu')); ?>" placeholder="08xxxxxxxxxx">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="jurusan_id" class="form-select" required>
                                            ...
                                            <option value="<?php echo e($j->id); ?>" <?php echo e(old('jurusan_id') == $j->id ? 'selected' : ''); ?>>
                                                <?php if($j->kode == 'PPLG'): ?>
                                                    💻 <?php echo e($j->nama); ?> (<?php echo e($j->kode); ?>)
                                                <?php elseif($j->kode == 'AKT'): ?>
                                                    📊 <?php echo e($j->nama); ?> (<?php echo e($j->kode); ?>)
                                                <?php elseif($j->kode == 'ANIMASI'): ?>
                                                    🎬 <?php echo e($j->nama); ?> (<?php echo e($j->kode); ?>)
                                                <?php elseif($j->kode == 'PEMASARAN'): ?>
                                                    📈 <?php echo e($j->nama); ?> (<?php echo e($j->kode); ?>)
                                                <?php elseif($j->kode == 'DKV'): ?>
                                                    🎨 <?php echo e($j->nama); ?> (<?php echo e($j->kode); ?>)
                                                <?php else: ?>
                                                    📚 <?php echo e($j->nama); ?> (<?php echo e($j->kode); ?>)
                                                <?php endif; ?>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="gelombang_id" class="form-select" required>
                                            ...
                                            <option value="<?php echo e($g->id); ?>" <?php echo e(old('gelombang_id') == $g->id ? 'selected' : ''); ?>>
                                                📅 <?php echo e($g->nama); ?> - <?php echo e($g->tahun); ?>

                                                <?php if($g->biaya_daftar): ?>
                                                    (Rp <?php echo e(number_format($g->biaya_daftar, 0, ',', '.')); ?>)
                                                <?php endif; ?>
                                            </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
<?php /**PATH C:\xampp\ppdb-app\resources\views/pendaftaran/create.blade.php ENDPATH**/ ?>
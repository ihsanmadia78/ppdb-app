    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link" href="{{ route('pendaftaran.create') }}">Daftar</a>
            </div>
        </div>
    </nav>
            ...
            <div class="col-lg-6">
                <div class="check-container">
                    ...
                    <div class="check-body">
                        ...
                        <form method="POST" action="{{ route('pendaftaran.cek.result') }}">
                            @csrf
                            <div class="mb-4">
            ...
            <div class="col-lg-8">
                <div class="status-card card">
                    ...
                    <div class="card-body">
                                        ...
                                        @foreach($pendaftar->statusTimeline as $status)
                                            <div class="timeline-item {{ $loop->last ? 'active' : 'completed' }}">
                                                <div class="timeline-marker bg-{{ App\Models\PendaftarStatus::getStatusColor($status->status) }}">
                                                    <i class="{{ App\Models\PendaftarStatus::getStatusIcon($status->status) }} text-white"></i>
                                                </div>
                        ...
                        @endphp
                        @if($currentStatus)
                            @if($currentStatus->status == 'SUBMIT')
                            ...
                            @elseif($currentStatus->status == 'VERIFIKASI_ADMIN')
                            ...
                            @elseif($currentStatus->status == 'MENUNGGU_PEMBAYARAN')
                        ...
                        <div class="text-center mt-4">
                            ...
                            @if($pendaftar->status == 'SUBMIT')
                                <a href="{{ route('pendaftaran.edit', $pendaftar->id) }}" class="btn btn-outline-secondary me-2">
                                    <i class="fas fa-edit me-1"></i>Edit Data
                                </a>
                                <a href="{{ route('berkas.index', $pendaftar->id) }}" class="btn btn-outline-secondary me-2">
                                    <i class="fas fa-upload me-1"></i>Upload Berkas
                                </a>
                                <a href="{{ route('pembayaran.index', $pendaftar->id) }}" class="btn btn-outline-success">

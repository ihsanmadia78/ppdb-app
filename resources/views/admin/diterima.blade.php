...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">✅ Pendaftar Diterima</h1>
            <p class="text-muted mb-0">Daftar siswa yang telah diterima di SMK BaktiNusantara 666</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('admin.dashboard') }}" class="btn btn-secondary btn-sm">
                <i class="fas fa-arrow-left"></i> Dashboard
            </a>
            <a href="{{ route('admin.export', ['status' => 'LULUS']) }}" class="btn btn-success btn-sm">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="small">Total Diterima</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="small">Jurusan Terisi</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success">📋 Data Pendaftar Diterima ({{ $pendaftar->count() }} siswa)</h6>
        </div>
        <div class="card-body">
            ...
            <div class="text-center py-5">
                ...
                <h5 class="text-gray-600">Belum Ada Pendaftar yang Diterima</h5>

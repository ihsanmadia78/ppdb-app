                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="tahun_ajaran" class="form-control" 
                                       value="{{ $settings['tahun_ajaran'] }}" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="number" name="max_pendaftar_per_jurusan" class="form-control" 
                                       value="{{ $settings['max_pendaftar_per_jurusan'] }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="biaya_pendaftaran" class="form-control" 
                                       value="{{ $settings['biaya_pendaftaran'] }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" name="periode_pendaftaran_mulai" class="form-control" 
                                       value="{{ $settings['periode_pendaftaran_mulai'] }}" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="date" name="periode_pendaftaran_selesai" class="form-control" 
                                       value="{{ $settings['periode_pendaftaran_selesai'] }}" required>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-6 mb-3">
                            <div class="h5 mb-0 text-gray-800">{{ \App\Models\Pendaftar::count() }}</div>
                            <small class="text-muted">Total Pendaftar</small>
                        </div>
                        <div class="col-6 mb-3">
                            <div class="h5 mb-0 text-gray-800">{{ \App\Models\User::count() }}</div>
                            <small class="text-muted">Total Users</small>
                        </div>
                        <div class="col-6 mb-3">
                            <div class="h5 mb-0 text-gray-800">{{ \App\Models\Jurusan::count() }}</div>
                            <small class="text-muted">Jurusan</small>
                        </div>
                        <div class="col-6 mb-3">
                            <div class="h5 mb-0 text-gray-800">{{ number_format(disk_free_space('/') / 1024 / 1024 / 1024, 1) }}GB</div>

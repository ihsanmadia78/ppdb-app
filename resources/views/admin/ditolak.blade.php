...
@section('title', 'Pendaftar Ditolak - Admin')
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">❌ Pendaftar Ditolak</h1>
            <p class="text-muted mb-0">Daftar siswa yang tidak dapat diterima pada periode ini</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('admin.dashboard') }}" class="btn btn-secondary btn-sm">
                <i class="fas fa-arrow-left"></i> Dashboard
            </a>
            <a href="{{ route('admin.export', ['status' => 'TIDAK_LULUS']) }}" class="btn btn-danger btn-sm">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="small">Total Ditolak</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-danger">📋 Data Pendaftar Ditolak ({{ $pendaftar->count() }} siswa)</h6>
        </div>
        <div class="card-body">
            ...
            <div class="text-center py-5">
                <i class="fas fa-user-times fa-4x text-gray-300 mb-3"></i>
                <h5 class="text-gray-600">Belum Ada Pendaftar yang Ditolak</h5>

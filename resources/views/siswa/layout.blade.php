...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container-fluid">
            <a class="navbar-brand d-flex align-items-center" href="{{ route('siswa.profil') }}">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <a href="{{ route('siswa.logout') }}" class="btn btn-outline-light btn-sm">
                ...
                <div class="sidebar" style="min-height: calc(100vh - 56px);">
                    <div class="p-4">
                        ...
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link {{ request()->routeIs('siswa.timeline') ? 'active' : '' }}" href="{{ route('siswa.timeline') }}">
                                <i class="fas fa-timeline me-3"></i>Timeline Status
                            </a>
                            <a class="nav-link {{ request()->routeIs('siswa.biodata') ? 'active' : '' }}" href="{{ route('siswa.biodata') }}">
                            ...
                            <a class="nav-link {{ request()->routeIs('siswa.perbaikan-berkas') ? 'active' : '' }}" href="{{ route('siswa.perbaikan-berkas') }}">
                                <i class="fas fa-upload me-3"></i>Perbaikan Berkas
                            </a>
                            <hr class="my-3">
                            <a class="nav-link" href="{{ route('siswa.cetak-kartu') }}" target="_blank">

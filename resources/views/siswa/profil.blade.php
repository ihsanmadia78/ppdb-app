                            ...
                            <div class="col-md-3 text-center">
                                <div class="card border-primary">
                                    <div class="card-body">
                                        ...
                                        <h6 class="text-dark fw-bold">{{ $pendaftar->dataSiswa->nama ?? 'Belum diisi' }}</h6>
                                        <p class="text-muted mb-0">{{ $pendaftar->no_pendaftaran }}</p>
                                        <span class="badge bg-{{ $pendaftar->status == 'LULUS' ? 'success' : ($pendaftar->status == 'TIDAK_LULUS' ? 'danger' : 'warning') }}">
                                            {{ $pendaftar->status }}
                                        </span>
                                    </div>
                                </div>
                                        ...
                                        <div class="timeline">
                                            ...
                                            <div class="timeline-item {{ in_array($pendaftar->status, ['SUBMIT', 'MENUNGGU_PEMBAYARAN', 'VERIFIKASI_PEMBAYARAN', 'SIAP_SELEKSI', 'LULUS', 'TIDAK_LULUS', 'CADANGAN']) ? 'completed' : 'pending' }}">
                                                ...
                                                <div class="timeline-content">
                                                    ...
                                                    <small class="timeline-date">{{ $pendaftar->created_at->format('d M Y, H:i') }}</small>
                                                </div>
                                            </div>
                                                ...
                                                <div class="timeline-content">
                                                    ...
                                                    @if($pendaftar->pembayaran)
                                                        ...
                                                        <p class="timeline-description">
                                                            {{ $statusText[$pendaftar->pembayaran->status] ?? 'Status Tidak Diketahui' }}
                                                            @if($pendaftar->pembayaran->status == 'rejected')
                                                                <br><small class="text-danger">Silakan upload ulang bukti pembayaran</small>
                                                            @endif
                                                        </p>
                                                        <small class="timeline-date">{{ $pendaftar->pembayaran->created_at->format('d M Y, H:i') }}</small>
                                                    @else
                                            ...
                                            <div class="timeline-item {{ $verificationStatus }}">
                                                ...
                                                <div class="timeline-content">
                                                    ...
                                                    @if($pendaftar->pembayaran && $pendaftar->pembayaran->status == 'verified')
                                                        ...
                                                        <small class="timeline-date">{{ $pendaftar->pembayaran->verified_at ? $pendaftar->pembayaran->verified_at->format('d M Y, H:i') : 'Terverifikasi' }}</small>
                                            ...
                                            <div class="timeline-item {{ in_array($pendaftar->status, ['LULUS', 'TIDAK_LULUS', 'CADANGAN']) ? 'completed' : 'pending' }}">
                                                ...
                                                <div class="timeline-content">
                                                    ...
                                                    @if($pendaftar->status == 'LULUS')
                                                        ...
                                                        <small class="timeline-date">{{ $pendaftar->updated_at->format('d M Y, H:i') }}</small>
                                ...
                                <div class="card border-primary">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-2">
                                                <a href="{{ route('siswa.profil') }}" class="btn btn-secondary btn-block">

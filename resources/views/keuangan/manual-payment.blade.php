...
@section('title', 'Input Manual Pembayaran - Keuangan')
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('keuangan.pembayaran.manual.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="nominal" class="form-control" value="{{ old('nominal') }}" placeholder="Contoh: 150000" required>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="datetime-local" name="tanggal_bayar" class="form-control" value="{{ old('tanggal_bayar', now()->format('Y-m-d\TH:i')) }}" required>
                    </div>

...
<div class="dashboard-container">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="stat-card stat-card-info">
                        <div class="stat-card-body">
                            ...
                            <div class="stat-content">
                                <div class="stat-number">{{ $diverifikasi }}</div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-lg-4 col-md-6">
            <a href="{{ route('verifikator.pendaftar', ['status' => 'SUBMIT']) }}" class="menu-card menu-card-warning text-decoration-none">
                <div class="menu-icon"><i class="fas fa-clock"></i></div>
                <div class="menu-title">Menunggu Verifikasi</div>
                <div class="menu-subtitle">{{ $menunggu }} pendaftar</div>
            </a>
        </div>
        <div class="col-lg-4 col-md-6">
            <a href="{{ route('verifikator.pendaftar') }}" class="menu-card menu-card-secondary text-decoration-none">
        ...
        <div class="col-lg-4 col-md-6">
            <a href="{{ route('verifikator.riwayat') }}" class="menu-card menu-card-info text-decoration-none">

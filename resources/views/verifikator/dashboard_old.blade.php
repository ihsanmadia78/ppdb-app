                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                            <a href="{{ route('verifikator.pendaftar', ['status' => 'SUBMIT']) }}" class="btn btn-warning w-100">
                                <i class="fas fa-clock me-1"></i> <span class="d-none d-sm-inline">Menunggu Verifikasi</span><span class="d-sm-none">Menunggu</span>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                            <a href="{{ route('verifikator.pendaftar') }}" class="btn btn-primary w-100">
                                <i class="fas fa-list me-1"></i> <span class="d-none d-sm-inline">Semua Pendaftar</span><span class="d-sm-none">Semua</span>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                            <a href="{{ route('verifikator.riwayat') }}" class="btn btn-info w-100">
                                <i class="fas fa-history me-1"></i> <span class="d-none d-sm-inline">Riwayat Verifikasi</span><span class="d-sm-none">Riwayat</span>
                            </a>
                        </div>
                    </div>
                </div>

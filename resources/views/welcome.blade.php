        ...
        <div class="container">
            <a class="navbar-brand" href="#">
                <div class="d-flex align-items-center">
                    <div class="navbar-logo me-3">
                        <img src="{{ asset('img/smk.png') }}" alt="Logo SMK" class="navbar-logo-img">
                    </div>
                    <div>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('pendaftaran.cek') }}">
                ...
                <div class="col-lg-6 text-center">
                    <div class="school-logo-container">
                        <div class="logo-frame">
                            <img src="{{ asset('img/smk.png') }}" alt="Logo SMK BaktiNusantara 666" class="school-logo-img">
                        </div>
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-center mb-3">
                        <div class="footer-logo me-3">
                            <img src="{{ asset('img/smk.png') }}" alt="Logo SMK" class="footer-logo-img">
                        </div>
                        <div>
